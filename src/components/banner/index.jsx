...
import ilips from '/public/ilips.png'


export default function Banner(){
    return(
        <div className="relative bg-gradient-to-r from-[#2DB7CA] to-[#01889A] rounded-[32px] px-[64px] pt-[66px] pb-[83px] max-phone-sm:pb-[50px] flex items-center justify-between max-lg:px-[30px] max-table-850:flex-col max-table-850:gap-y-6 max-phone-sm:px-[20px]">
                {/* <Image
                    src={ilips}
                    alt="logo"
                    className='absolute '
            ...
            <div className='w-[60%] max-table-850:w-full'>
                ...
                <button className="sendButton text-primaryblue text-lg max-phone:text-sm font-medium leading-normal px-[24px] py-[16px] bg-white transition-[2.9s] hover:bg-raisinBlack  hover:text-white">Связаться с нами</button>
            </div>
